...
import 'package:car_rental_app/pacakges/locationpicker/lib/widgets/rich_suggestion.dart';
import 'package:car_rental_app/pacakges/locationpicker/lib/widgets/search_input.dart';
import 'package:car_rental_app/pacakges/locationpicker/lib/widgets/select_place_action.dart';
  ...
  Future<LatLng> _getCurrentLocation() async {
    ...
    if (permission == LocationPermission.denied) {
      ...
      if (permission == LocationPermission.denied) {
        ...
        // your App should show an explanatory UI  DateTime.now().
